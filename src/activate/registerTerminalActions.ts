...
const TERMINAL_COMMAND_IDS = {
	ADD_TO_CONTEXT: "ecdysis-agent.terminalAddToContext",
	FIX: "ecdysis-agent.terminalFixCommand",
	FIX_IN_CURRENT_TASK: "ecdysis-agent.terminalFixCommandInCurrentTask",
	EXPLAIN: "ecdysis-agent.terminalExplainCommand",
	EXPLAIN_IN_CURRENT_TASK: "ecdysis-agent.terminalExplainCommandInCurrentTask",
} as const
